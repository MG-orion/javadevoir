...
import gestion_atelier_db.repositories.list.TableArticleConfections;
import gestion_atelier_db.repositories.list.TableCategories;
import gestion_atelier_db.services.ArticleConfectionService;
import gestion_atelier_db.services.ArticleConfectionServiceImpl;
                    ...
                    do {
                        ...
                        switch (choix2) {
                            case 1:
                                ...
                                //1article.setCategorie(categorieServiceImpl.get(scanner.nextInt()));
